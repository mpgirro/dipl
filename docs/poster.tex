...
\newcommand*\openquote{\makebox(25,-22){\scalebox{5}{\grqq}}}
        ...
        \begin{column}{.46\textwidth}
          {\lmodern\justify
            \begin{justify}
              ...
              \vspace*{.5\baselineskip}
              The time constraints of the retrieval phase favours synchronous
              interaction. Actors use a request/asynchronous response style.
              This semi-synchronous strategy shows better efficiency than
              strictly synchronous communication.  
            \end{justify}
          }
        \end{column}
      \end{columns}
