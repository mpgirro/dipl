...
public class JSR310ZonedDateTimeDeserializer extends JsonDeserializer<ZonedDateTime> {
    ...
    private DateMapper dateMapper = DateMapper.INSTANCE;
        ...
        switch(parser.getCurrentToken()) {
            ...
            case VALUE_STRING:
                ...
                if(string.length() == 0) {
                    ...
                    final LocalDateTime dateTime = LocalDateTime.parse(string, ISO_OFFSET_DATE_TIME);
                    return dateMapper.asZonedDateTime(dateTime);
                } else {
                    final LocalDateTime dateTime = LocalDateTime.parse(string, ISO_DATE_TIME);
                    return dateMapper.asZonedDateTime(dateTime);
                }
