...
public class RabbitConfig {
    ...
    */
    ...
    @Bean
    SimpleMessageListenerContainer parserListenerContainer(ConnectionFactory connectionFactory,
                                                           @Qualifier("parserListenerAdapter") MessageListenerAdapter listenerAdapter,
