...
import echo.microservice.catalog.async.ExceptionHandlingAsyncTaskExecutor;
...
public class AsyncConfig implements AsyncConfigurer {
    ...
    @Value("${echo.catalog.core-pool-size:2}")
    private Integer CORE_POOL_SIZE;

    @Value("${echo.catalog.max-pool-size:50}")
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setThreadNamePrefix("echo-catalog-Executor-");
