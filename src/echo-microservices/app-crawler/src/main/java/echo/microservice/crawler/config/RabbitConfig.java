...
public class RabbitConfig {
    ...
    */
    ...
    @Bean
    SimpleMessageListenerContainer crawlerListenerContainer(ConnectionFactory connectionFactory, @Qualifier("crawlerListenerAdapter") MessageListenerAdapter listenerAdapter) {
