...
object CatalogProtocol {
    ...
    case class ProposeNewFeed(url: String, rtt: RoundTripTime) extends CatalogCommand                 // Web/CLI -> CatalogStore
    case class RegisterEpisodeIfNew(podcastExo: String, episode: EpisodeDTO, rtt: RoundTripTime) extends CatalogCommand // Questions: Parser -> CatalogStore
