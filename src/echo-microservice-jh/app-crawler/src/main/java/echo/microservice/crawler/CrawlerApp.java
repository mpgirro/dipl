...
import echo.microservice.crawler.config.ApplicationProperties;
import echo.microservice.crawler.config.DefaultProfileUtil;
...
public class CrawlerApp {
    ...
    public CrawlerApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CrawlerApp.class);
