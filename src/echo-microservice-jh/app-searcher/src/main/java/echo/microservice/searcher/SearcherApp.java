...
import echo.microservice.searcher.config.ApplicationProperties;
import echo.microservice.searcher.config.DefaultProfileUtil;
...
public class SearcherApp {
    ...
    public SearcherApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SearcherApp.class);
