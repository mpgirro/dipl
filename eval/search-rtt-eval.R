...
#
akka_search10000_rtt_progress <- read.table("../src/benchmark/data/akka-search500-rtt-progress.csv", header=T, sep=";");
msa_search10000_rtt_progress <- read.table("../src/benchmark/data/msa-search500-rtt-progress.csv", header=T, sep=";");
